...
(defonce all-products
  [{:product-group "Seating" :product-type "Lounge Chairs" :product-id :barcelona-chair :product-name "Barcelona Chair" :short-text "Barcelona Chair short text" :lead-times [:std :quick :three-week] :thumb-img-src "https://www.knoll.com/media/858/141/205_barcelona_lounge_black_F_v3.png" :hero1-img-src "https://www.knoll.com/media/858/141/205_barcelona_lounge_black_F_v3.png"}
   ...
   {:product-group "Seating" :product-type "Multi-Use Chairs" :product-id :bertoia-molded-shell-side-chair :product-name "Bertoia Molded Shell Side Chair" :short-text "Bertoia Molded Shell Side Chair short text":lead-times [:three-week] :thumb-img-src "https://www.knoll.com/media/47/66/Thumb_Thumb_bertoia-molded-shell-chair-default,4.png" :hero1-img-src "https://www.knoll.com/media/47/66/Thumb_Thumb_bertoia-molded-shell-chair-default,4.png"}])
